  ...
  return (
    <main  className='container mx-auto py-20 px-6'>
      <section className='hero text-gray-700 max-w-2xl'>
        <h1 className='sm:text-6xl text-5xl font-medium mb-6'>Instant Mock APIs for Developers</h1>
        <h2 className='text-lg'>A public fake REST API made for developers. Test features, debug, and prototype without touching a real database.</h2>
        <button onClick={handleScroll} className='bg-blue-500 rounded-lg shadow-md flex items-center gap-1 px-4 py-2 cursor-pointer text-white my-4 transition duration-300 hover:scale-[0.95]'>Explore Docs
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 my-20">
            ...
            <div className="bg-white/90 hover:scale-[1.05] backdrop-blur-sm shadow-lg rounded-2xl p-6 card-shadow hover-lift transition duration-300">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                        <div className="text-2xl font-bold text-forest-800">24</div>
      ...
      <div className='my-10'>
        ...
        <p className='text-black mt-2'>MockHub API offers simple, plug-and-use fake endpoints designed for fast development. Whether you’re prototyping, learning APIs, or showcasing features, you can start sending requests immediately.</p>
      </div>
