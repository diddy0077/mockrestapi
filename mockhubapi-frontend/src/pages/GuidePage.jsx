...
const GuidePage = () => {
  ...
  return (
    <main className='container mx-auto p-6'>
      <section className='py-6 hero'>
        ...
        <p className='text-gray-700 mt-6'>This page shows quick examples using the Fetch API, but you can interact with MockHub from any language or framework that can send HTTP requests.You can copy these examples directly into your browser console or your code editor to test the API instantly.</p>
      </section>

      <section className='mt-16'>
        <div>
          <h1 className='text-2xl font-bold mb-5'>🚀 Fetching a Single Resource</h1>
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-xs sm:text:sm ml-4'>fetch-example.js</span>
              </div>
              <div className='flex items-center space-x-2'>
                <span className='text-[#858585] text-xs'>js</span>
                <button
                  onClick={() => copyToClipboard(`fetch('https://mockhub-api.com/api/posts/1')
  .then(res => res.json())
  .then(data => console.log(data));`, 'fetch-single')}
            ...
            <div className='p-4'>
              <div className='flex'>
                {/* Line Numbers */}
                <div className='text-[#858585] text-right pr-4 select-none' style={{minWidth: '2rem'}}>
                  <div>1</div>
                  <div>2</div>
                  <div>3</div>
                </div>
                ...
                <div className='flex-1 text-[#d4d4d4]'>
                  <div>
                    ...
                    <span className='text-[#ce9178]'>'https://mockhub-api.com/api/posts/1'</span>
                    <span className='text-[#d4d4d4]'>)</span>
                  </div>
                  <div className='ml-4'>
                  ...
                  <div className='ml-4'>
                    <span className='text-[#dcdcaa]'>.then</span>
                    <span className='text-[#d4d4d4]'>(function(data) {'{'}</span>
      ...
      <section className='mt-16'>
        <div>
          <h1 className='text-2xl font-bold mb-5'>📃 Fetching All Items in a Collection</h1>
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-xs sm:text-sm ml-4'>fetch-all.js</span>
              </div>
              <div className='flex items-center space-x-2'>
                <span className='text-[#858585] text-xs'>js</span>
                <button
                  onClick={() => copyToClipboard(`fetch('https://mockhub-api.com/api/posts')
  .then(res => res.json())
  .then(data => console.log(data));`, 'fetch-all')}
                  className='px-2 py-1 text-xs bg-[#3c3c3c] hover:bg-[#4c4c4c] text-[#cccccc] rounded transition-colors'
                >
              ...
              <div className='flex'>
                ...
                <div className='flex-1 text-[#d4d4d4]'>
                  <div>
                    <span className='text-[#4ec9b0]'>fetch</span>
                    <span className='text-[#d4d4d4]'>(</span>
                    <span className='text-[#ce9178]'>'https://mockhub-api.com/api/posts'</span>
                    <span className='text-[#d4d4d4]'>)</span>
                  </div>
                  <div className='ml-4'>
                    <span className='text-[#dcdcaa]'>.then</span>
      ...
      <section className='mt-16'>
        <div>
          <h1 className='text-2xl font-bold mb-5'>➕ Creating a New Resource</h1>
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-xs sm:text-sm ml-4'>create-post.js</span>
              </div>
              <div className='flex items-center space-x-2'>
                <span className='text-[#858585] text-xs'>js</span>
                <button
  ...
  .then(data => console.log(data));`, 'create-post')}
              ...
              <div className='flex'>
                ...
                <div className='flex-1 text-[#d4d4d4]'>
                  ...
                  <div className='ml-8'>
                    ...
                    <span className='text-[#d4d4d4]'>: </span>
                    <span className='text-[#ce9178]'>"This is a new post created for testing."</span>
                    <span className='text-[#d4d4d4]'>,</span>
                  </div>
                  <div className='ml-8'>
      ...
      <section className='mt-16'>
        <div>
          <h1 className='text-2xl font-bold mb-5'>✏️ Updating a Resource (PUT)</h1>
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-xs sm:text-sm ml-4'>update-post.js</span>
              </div>
              <div className='flex items-center space-x-2'>
                <span className='text-[#858585] text-xs'>js</span>
                <button
  ...
  .then(res => res.json())
  .then(data => console.log(data));`, 'update-post')}
                  className='px-2 py-1 text-xs bg-[#3c3c3c] hover:bg-[#4c4c4c] text-[#cccccc] rounded transition-colors'
                >
              ...
              <div className='flex'>
                ...
                <div className='flex-1 text-[#d4d4d4]'>
                  ...
                  <div className='ml-8'>
                    <span className='text-[#9cdcfe]'>body</span>
                    <span className='text-[#d4d4d4]'>: </span>
                    <span className='text-[#ce9178]'>"Updated body content"</span>
                    <span className='text-[#d4d4d4]'>,</span>
                  </div>
                  <div className='ml-8'>
                    <span className='text-[#9cdcfe]'>userId</span>
      ...
      <section className='mt-16'>
        <div>
          <h1 className='text-2xl font-bold mb-5'>🩹 Modifying Part of a Resource (PATCH)</h1>
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-xs sm:text-sm ml-4'>patch-post.js</span>
              </div>
              <div className='flex items-center space-x-2'>
                <span className='text-[#858585] text-xs'>js</span>
                <button
  ...
  .then(res => res.json())
  .then(data => console.log(data));`, 'patch-post')}
                  className='px-2 py-1 text-xs bg-[#3c3c3c] hover:bg-[#4c4c4c] text-[#cccccc] rounded transition-colors'
                >
              ...
              <div className='flex'>
                ...
                <div className='flex-1 text-[#d4d4d4]'>
                  ...
                  <div className='ml-8'>
                    <span className='text-[#9cdcfe]'>body</span>
                    <span className='text-[#d4d4d4]'>: </span>
                    <span className='text-[#ce9178]'>"Only updating the body field"</span>
                  </div>
                  <div className='ml-4'>
                    <span className='text-[#d4d4d4]'>{'}): {'}</span>
                  </div>
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-xs sm:text-sm ml-4'>delete-post.js</span>
              </div>
              <div className='flex items-center space-x-2'>
                <span className='text-[#858585] text-xs'>js</span>
                <button
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-xs sm:text-sm ml-4'>filter-posts.js</span>
              </div>
              <div className='flex items-center space-x-2'>
                <span className='text-[#858585] text-xs'>js</span>
                <button
                  onClick={() => copyToClipboard(`fetch('https://mockhub-api.com/api/posts?userId=14')
  .then(res => res.json())
  .then(data => console.log(data));`, 'filter-posts')}
                  className='px-2 py-1 text-xs bg-[#3c3c3c] hover:bg-[#4c4c4c] text-[#cccccc] rounded transition-colors'
                >
              ...
              <div className='flex'>
                ...
                <div className='flex-1 text-[#d4d4d4]'>
                  <div>
                    <span className='text-[#4ec9b0]'>fetch</span>
                    <span className='text-[#d4d4d4]'>(</span>
                    <span className='text-[#ce9178]'>'https://mockhub-api.com/api/posts?userId=14'</span>
                    <span className='text-[#d4d4d4]'>)</span>
                  </div>
                  <div className='ml-4'>
                    <span className='text-[#dcdcaa]'>.then</span>
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm mb-4'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-xs sm:text-sm ml-4'>nested-comments.js</span>
              </div>
              <div className='flex items-center space-x-2'>
                <span className='text-[#858585] text-xs'>js</span>
                <button
                  onClick={() => copyToClipboard(`fetch('https://mockhub-api.com/api/posts/1/comments')
  .then(res => res.json())
  .then(data => console.log(data));`, 'nested-comments')}
                  className='px-2 py-1 text-xs bg-[#3c3c3c] hover:bg-[#4c4c4c] text-[#cccccc] rounded transition-colors'
                >
              ...
              <div className='flex'>
                ...
                <div className='flex-1 text-[#d4d4d4]'>
                  <div>
                    <span className='text-[#4ec9b0]'>fetch</span>
                    <span className='text-[#d4d4d4]'>(</span>
                    <span className='text-[#ce9178]'>'https://mockhub-api.com/api/posts/1/comments'</span>
                    <span className='text-[#d4d4d4]'>)</span>
                  </div>
                  <div className='ml-4'>
                    <span className='text-[#dcdcaa]'>.then</span>
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-xs sm:text-sm ml-4'>query-filter.js</span>
              </div>
              <span className='text-[#858585] text-xs'>js</span>
            </div>
            ...
            <div className='p-4'>
              <div className='flex'>
                ...
                <div className='flex-1 text-[#d4d4d4]'>
                  <div>
                    <span className='text-[#d4d4d4]'>/posts?postId=1</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className='mt-16'>
        <div>
          <h1 className='text-2xl font-bold mb-5'>🎯 Getting a Single Nested Resource</h1>
          
          <div className='mb-6'>
            <p className='text-gray-700 max-w-4xl'>
              You can access a specific nested resource using the resource IDs in the URL path.
            </p>
            <p className='text-gray-700 max-w-4xl mt-2 font-medium'>
          ...
          <div className='bg-[#1e1e1e] rounded-lg overflow-hidden max-w-4xl shadow-lg font-mono text-sm'>
            ...
            <div className='bg-[#2d2d30] px-4 py-2 flex items-center justify-between border-b border-[#3e3e42]'>
              <div className='flex items-center space-x-2'>
                ...
                <span className='text-[#cccccc] text-sm ml-4'>single-comment.js</span>
              </div>
              <div className='flex items-center space-x-2'>
                <span className='text-[#858585] text-xs'>js</span>
                <button
                  onClick={() => copyToClipboard(`fetch('https://mockhub-api.com/api/posts/1/comments/5')
  .then(res => res.json())
  .then(data => console.log(data));`, 'single-comment')}
                  className='px-2 py-1 text-xs bg-[#3c3c3c] hover:bg-[#4c4c4c] text-[#cccccc] rounded transition-colors'
                >
              ...
              <div className='flex'>
                ...
                <div className='flex-1 text-[#d4d4d4]'>
                  <div>
                    <span className='text-[#4ec9b0]'>fetch</span>
                    <span className='text-[#d4d4d4]'>(</span>
                    <span className='text-[#ce9178]'>'https://mockhub-api.com/api/posts/1/comments/5'</span>
                    <span className='text-[#d4d4d4]'>)</span>
                  </div>
                  <div className='ml-4'>
                    <span className='text-[#dcdcaa]'>.then</span>
          ...
          <div className='mt-6'>
            <p className='text-gray-600 max-w-4xl border-l border-l-7 border-blue-600 bg-white rounded-lg p-2'>
              This endpoint returns a single comment object with the specified ID (5) from post ID 1.
            </p>
          </div>
        </div>
      </section>
